...
public class EditKoleksiPanel extends EditPanel {
    ...
    EditKoleksiPanel(JFrame frame, DaoPerpus dtKoleksi) {
        super(frame);
    ...
    public boolean addKoleksi() {
        ...
        switch (selectedIndex) {
            case 0:
                dtKoleksi.dataPerpus.insertBuku(values[0], values[1], values[2], values[3], values[4]);
                break;
            case 1:
                dtKoleksi.dataPerpus.insertDisk(values[0], values[1], values[2], values[3], values[4]);
                break;
            case 2:
                dtKoleksi.dataPerpus.insertMajalah(values[0], values[1], values[2], values[3], values[4],values[5]);
                break;
            default:
    ...
    private void refreshTable() {
        model.setRowCount(0);
        try {
            for (Koleksi koleksi : dtKoleksi.getKoleksiList()) {
